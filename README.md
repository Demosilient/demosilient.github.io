...
- [FairPhone](https://www.fairphone.com/) and [Framework Computer](https://frame.work/), these are the sort of businesses we want to become mainstream, there is good mutually beneficial symbiosis here on hardware and software level.
